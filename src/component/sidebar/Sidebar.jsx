      ...
      >
        <ListItem disablePadding>
          ...
          >
            ...
            >
              <img src={images.dashboardImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="Dashboard"
              sx={{
        ...
        <ListItem disablePadding>
          ...
          >
            ...
            >
              <img src={images.profileImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="Profile"
              sx={{
        ...
        <ListItem disablePadding>
          <ListItemButton
            sx={{
              backgroundColor:
                "/enquiryMaterial" === location.pathname ? "#4744b1" : "transparent",
              color: "/enquiryMaterial" === location.pathname ? "black" : "inherit",
          ...
          >
            <ListItemIcon sx={{ color: "white" }}>
              <img src={images.cashPaymentImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="My Payments"
              sx={{
        ...
        <ListItem disablePadding>
          <ListItemButton component={Link} to="/my_material"
            sx={{
              backgroundColor:
                "/my_material" === location.pathname ? "#4744b1" : "transparent",
          ...
          >
            <ListItemIcon sx={{ color: "white" }}>
              <img src={images.rawMaterialImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="My Material"
              sx={{
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemIcon sx={{ color: "white" }}>
              <img src={images.termsImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemIcon sx={{ color: "white" }}>
              <img src={images.moreImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="More"
              sx={{
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemIcon sx={{ color: "white" }}>
              <img src={images.logOutImg} alt="" style={{ width: '20px', height: '20px' }} />
            </ListItemIcon>
            <ListItemText
              primary="Logout"
              sx={{
